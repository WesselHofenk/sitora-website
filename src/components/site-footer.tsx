  ...
  return (
    <footer className="bg-[#040b14] pb-8 pt-16 text-slate-300 sm:pt-20">
      <div className="mx-auto max-w-[86rem] px-5 sm:px-8 lg:px-10">
        ...
        <div className="flex flex-col gap-2 rounded-xl bg-white/[.03] p-5 text-xs text-slate-500 sm:flex-row sm:justify-between"><p>© {new Date().getFullYear()} Sitora · {business.ownerName} · KvK {business.chamberOfCommerce} · btw {business.vatNumber}</p><p>{business.openingHours}</p></div>
      </div>
    </footer>
  );
}
