    ...
    <footer className="bg-[#040b14] pb-8 pt-16 text-slate-300 sm:pt-20">
      <div className="mx-auto max-w-[86rem] px-5 sm:px-8 lg:px-10">
        <div className="grid gap-8 pb-12 lg:grid-cols-[1.35fr_.65fr] lg:items-end">
          ...
          <Link href="/contact#advies" className="group inline-flex min-h-12 w-fit items-center gap-3 rounded-full bg-orange-700 px-6 font-black text-white transition-colors hover:bg-orange-800 lg:justify-self-end">Gratis websiteadvies <ArrowUpRight className="size-4 transition-transform group-hover:translate-x-1 group-hover:-translate-y-1" /></Link>
        </div>
