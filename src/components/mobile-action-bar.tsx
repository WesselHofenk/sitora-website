...
export function MobileActionBar() {
  ...
  return (
    <div className="fixed inset-x-3 bottom-3 z-40 grid [grid-template-columns:repeat(auto-fit,minmax(0,1fr))] overflow-hidden rounded-2xl border border-white/10 bg-blue-950 p-1 text-white shadow-2xl md:hidden">
