    ...
    <header className="sticky top-0 z-50 bg-[#f6f3ed]/95 shadow-sm backdrop-blur-md">
      <div className="mx-auto flex h-[68px] max-w-[86rem] items-center justify-between gap-6 px-5 sm:h-[76px] sm:px-8 lg:px-10">
        ...
        <div className="flex items-center gap-3">
          ...
          <button type="button" aria-label={open ? "Menu sluiten" : "Menu openen"} aria-expanded={open} aria-controls="mobiel-menu" onClick={() => setOpen((value) => !value)} className="grid size-11 place-items-center rounded-full bg-white text-slate-950 transition-colors hover:bg-slate-100 xl:hidden">
      ...
      {open ? (
        <div id="mobiel-menu" className="fixed inset-x-0 bottom-0 top-[68px] z-40 overflow-y-auto bg-[#07111f] text-white sm:top-[76px] xl:hidden">
