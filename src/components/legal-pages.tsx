...
export function PrivacyPage() {
  const sections: Array<[string, string]> = [
    ...
    ["Welke gegevens verwerkt het aanvraagformulier?", "Het formulier kan naam, bedrijfsnaam, e-mailadres, telefoonnummer, branche, website-status, gekozen pakket of dienst en je bericht verwerken. Bij een vaste pakketaanvraag zijn naam, bedrijfsnaam, e-mailadres, telefoonnummer, pakket, opmerkingen en toestemming verplicht. Een maatwerkofferte vraagt daarnaast naar type website, omvang, gewenste functies, aanwezige merkonderdelen, planning en budget. Het algemene adviesformulier behoudt zijn bestaande compacte velden."],
