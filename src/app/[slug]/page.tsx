...
function PrivacyPage() {
  const sections = [
    ...
    ["Formulieren en e-mail", "Het formulier verstuurt de aanvraag naar Sitora. Wanneer Resend in productie is geconfigureerd, verwerkt Resend de e-mailbezorging als dienstverlener. Er worden geen gevoelige persoonsgegevens uitgevraagd."],
