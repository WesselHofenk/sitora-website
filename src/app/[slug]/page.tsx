...
function PrivacyPage() {
  const sections = [
    ...
    ["Formulieren en e-mail", "Het formulier verstuurt de aanvraag via de beveiligde mailserver van Sitora naar de zakelijke mailbox. Er worden geen gevoelige persoonsgegevens uitgevraagd."],
